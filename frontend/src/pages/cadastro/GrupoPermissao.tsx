...
export default function GrupoPermissaoPage() {
  ...
  const openEdit = (item: GrupoPermissao) => {
    setEditItem(item);
    formik.setValues({
      nome: item.nome,
    ...
    <div className="space-y-4" data-testid="grupo-permissao-page">
        ...
        <Card className="card-hover">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-bold font-display">{totalUsuarios}</p>
            </div>
          </CardContent>
        </Card>
        <Card className="card-hover">
            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                ...
                <Input
                  ...
                  data-testid="grupo-permissao-search"
                />
              </div>
              <Button
                size="sm"
                ...
                onClick={openCreate}
                data-testid="grupo-permissao-add-btn"
              >
          ...
          <Table>
            ...
            <TableBody>
              {filtered.map((item) => (
                <TableRow
                  key={item.id}
                  data-testid={`grupo-permissao-row-${item.id}`}
                >
                  ...
                  <TableCell>
                    <div className="flex items-center gap-1">
                      <Button
                        ...
                        data-testid={`edit-grupo-permissao-${item.id}`}
                      >
                      ...
                      <Button
                        ...
                        data-testid={`delete-grupo-permissao-${item.id}`}
                      >
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent
          ...
          data-testid="grupo-permissao-dialog"
        >
          <DialogHeader>
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                data-testid="grupo-permissao-nome"
              />
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className={`h-9 text-sm ${formik.touched.descricao && formik.errors.descricao ? "border-destructive" : ""}`}
                data-testid="grupo-permissao-descricao"
              />
            </div>
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                {allPermissions.map((perm) => (
                  ...
                  >
                    <Checkbox
                      checked={formik.values.permissoes.includes(perm)}
              ...
              {formik.touched.permissoes && formik.errors.permissoes && (
                <p className="text-[11px] text-destructive">
                  {formik.errors.permissoes as string}
                </p>
              )}
            </div>
            <DialogFooter className="gap-2">
              ...
              <Button
                type="submit"
                size="sm"
                data-testid="grupo-permissao-submit-btn"
              >
